...
In this analysis, let us only focus on the laboratories that used Headturn procedure (HPP) with North-American English speaking babies in the analysis for a simple illustration.
...
ggplot(data = mb1_data, aes(x = trial_num, y = looking_time, color = trial_type)) +
  ...
  facet_wrap(~age_group, ncol = 3, nrow = 3) +
  ylab("Looking time") +
  xlab("Trial number") + 
