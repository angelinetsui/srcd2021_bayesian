...
Freq_model <- lmer(log_look_time ~ center_age_mo:trial_type + center_trial_num:trial_type + center_trial_order:trial_type + nae:trial_type + gender:trial_type + (1 + center_trial_num+trial_type|subid), control=lmerControl(optimizer="bobyqa"), #using an optimizer that aligns with the version in MB1 and MB1B
                   data = mb1_data) 
...
```{r}
Bayes_model_default <- brm(looking_time ~ center_age_mo:trial_type + center_trial_num:trial_type + center_trial_order:trial_type + nae:trial_type + gender:trial_type + (1 + center_trial_num + trial_type | subid),
                   family = lognormal(),
                   data = mb1_data,
                   warmup = 1000, 
                   iter = 4000, 
...
```{r}
Bayes_model_priors <- brm(looking_time ~ center_age_mo:trial_type + center_trial_num:trial_type + center_trial_order:trial_type + nae:trial_type + gender:trial_type + (1 + center_trial_num +trial_type |subid),
                   family = lognormal(),
                   prior = priors,
                   data = mb1_data,
                   warmup = 1000, 
